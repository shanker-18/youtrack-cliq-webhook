    ...
    if authenticated:
        user_section = html.Div(
            ...
            children=[
                ...
                dbc.Button([html.I(className="bi bi-box-arrow-right me-1"), "Sign Out"], href="/logout", external_link=True, color="outline-danger", size="sm", className="px-3")
            ]
        )
    else:
        user_section = html.Div(
    ...
    return dbc.Navbar(
        ...
        children=[
            dbc.NavbarBrand(
                ...
                href="/",
                children=[
                    html.Span("KENVUE", className="fw-bold fs-4 text-danger me-2"),
